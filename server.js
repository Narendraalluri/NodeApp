...
var FileContent = mongoose.model('FileContent', {
    content: Buffer
});
...
app.get('/viewUserTimesheets', function(req, res) {
    ...
    timeSheet.find({
        "userId": userId
    }, '_id startDate endDate total clientApproved', function(err, data) {
...
app.get('/viewTimesheets', function(req, res) {
    ...
    }, 'clientApproved name originalName startDate endDate monday tuesday wednesday thursday friday saturday sunday _id status', function(err, data) {
...
app.post('/updateTimesheet', function(req, res) {
    ...
    try {
        ...
        fs.readFile(tmp_path, function(err, data) {
            console.log("before")
            timeSheet.findByIdAndUpdate(req.body.id, {
                $set: {
                    clientApproved: req.body.clientApproved,
                    originalName: req.files.timesheet.originalname,
                    content: data,
...
app.post('/modifyTimeSheet', function(req, res) {
    ...
    ts.sheets = req.body.sheets
    console.log(req.body.sheets)
    timeSheet.findByIdAndUpdate(req.query.id, {
        $set: {
